                                ...
                                props.shows.map((show, index) => (
                                    ...
                                    <>
                                        <Link href="/works/[id]" as={`/works/${show.fields.slug}`}>
                                            <motion.div initial="hidden" animate="visible" transition="transition" custom={index} variants={variants} className="col-md-6 col-lg-4 g-4" Style="align-items: stretch;" key={`worklist-${show.fields.slug}`} >
