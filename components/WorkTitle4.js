...
const WorkTitle4 = ({index=0, length=0, title, description="", category="", tags=[], abstract="", thumbnail={}}) => (
  <>
  ...
  <div className="jumbotron-fluid mb-5 py-0 py-lg-0" style={{backgroundColor: "#ecf2f2", height: "40vh", minHeight: "480px"}}>
